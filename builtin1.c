...
/**
 * _myhistory - shows the history list line by line, with line numbers
 *              coming before each command, starting at 0.
...
/**
 * _myalias - copycat the alias builtin (man alias)
 * @info: the structure holding arguments.  to maintain fntn prototype.
 *  Return: Always 0
 */
